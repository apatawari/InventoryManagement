    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recieving_date', models.DateField(default='2020-10-28')),
                ('processing_party_name', models.CharField(default='-', max_length=50)),
                ('total_bale', models.IntegerField()),
                ('checking_date', models.DateField(default='2020-10-28')),
                ('sent_to_processing_date', models.DateField(default='2020-10-28')),
                ('recieve_processed_date', models.DateField(default='2020-10-28')),
                ('total_thans', models.IntegerField()),
                ('total_mtrs', models.IntegerField()),
            ],
        ),
    ]
